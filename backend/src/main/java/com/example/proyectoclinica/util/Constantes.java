package com.example.proyectoclinica.util;
...
public class Constantes {
    ...
    public static abstract class RESPUESTA_CONTROLADOR {
        ...
        public final static String MENSAJE_CREAR_ERROR = "Error al crear {0}, contactar a Soporte Tecnico";
        public final static String MENSAJE_ACTUALIZAR_ERROR = "Error al actualizar {0}, contactar a Soporte Tecnico";
        public final static String MENSAJE_ELIMINAR_ERROR = "Error al eliminar {0}, contactar a Soporte Tecnico";
    }
